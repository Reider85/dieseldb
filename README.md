...
DieselDB - Экспериментальная база данных на Java 17, разработанная Reider85 с использованием ИИ средств.
...
DieselDB – Eine experimentelle Datenbank auf Basis von Java 17, entwickelt von Reider85 unter Einsatz von KI-Tools.
...
DieselDB - 实验性数据库，基于 Java 17 开发，由 Reider85 借助 AI 工具创建。
