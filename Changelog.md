...
- Quick 248/0/0/6, full suite (4GB, @LargeTest) 248/0/0/0 BUILD SUCCESS, timing: heavy (>=100ms) queries stable - SubqueriesTest 194.3ms -> 210.2ms (+8%), JoinTest heavy inner join dropped below 100ms; the only ratio>1.2 deltas were micro-queries with 11-19ms baselines (machine noise), no heavy-query regression